all: server
server: obj/ConnectionHandler.o obj/DateTime.o obj/HttpConnectionHandler.o obj/HttpException.o obj/HttpHeaderReader.o obj/main.o obj/Resource.o obj/Server.o
	g++ obj/ConnectionHandler.o obj/DateTime.o obj/HttpConnectionHandler.o obj/HttpException.o obj/HttpHeaderReader.o obj/main.o obj/Resource.o obj/Server.o -Wall -O3 -lpthread -lboost_regex -o server
